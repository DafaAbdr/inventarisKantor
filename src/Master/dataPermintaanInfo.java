 ...
 * @author dafaa
 */
public class dataPermintaanInfo extends javax.swing.JFrame {
    ...
    protected void dataTable(){
        Object[] baris = {"id_permintaan", "id_barang", "nama_barang", "jumlah_barang", "tanggal"};
        tabmode = new DefaultTableModel(null, baris);
        tablePermintaanInfo.setModel(tabmode);
        
        String sql = "SELECT * FROM dataPermintaanInfo";
    ...
    private void initComponents() {
        ...
        tablePermintaanInfo = new javax.swing.JTable();
        ...
        tablePermintaanInfo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID Permintaan", "ID Barang ", "Nama Barang", "Jumlah Barang", "Tanggal"
            }
        ) {
        ...
        tablePermintaanInfo.setShowGrid(true);
        tablePermintaanInfo.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                tablePermintaanInfoAncestorAdded(evt);
            }
        ...
        tablePermintaanInfo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablePermintaanInfoMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tablePermintaanInfo);
    ...
    private void bTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTambahActionPerformed
        ...
        String sql = "INSERT INTO dataPermintaanInfo (id_permintaan, id_barang, nama_barang, jumlah_barang, tanggal) VALUES (?, ?, ?, ?, ?)";
    ...
    private void tablePermintaanInfoAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tablePermintaanInfoAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_tablePermintaanInfoAncestorAdded

    private void tablePermintaanInfoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePermintaanInfoMouseClicked
        int baris = tablePermintaanInfo.getSelectedRow();
        if (baris != -1) {
    ...
    }//GEN-LAST:event_tablePermintaanInfoMouseClicked
    ...
    private void bCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCariActionPerformed
        ...
        String sql = "SELECT * FROM dataPermintaanInfo WHERE " +
    ...
    private void bHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHapusActionPerformed
        try {
            String sql = "DELETE FROM dataPermintaanInfo WHERE `id_permintaan`=?";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, idPermintaan.getText());
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        try {
            ...
            String sql = "UPDATE dataPermintaanInfo SET `id_barang`=?, `nama_barang`=?, `jumlah_barang`=?, `tanggal`=?  WHERE `id_permintaan`=?";
            ...
            ps.setString(5, idPermintaan.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataPermintaanInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataPermintaanInfo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablePermintaanInfo;
