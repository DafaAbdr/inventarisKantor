 ...
 * @author dafaa
 */
public class dataPeminjamanInfo extends javax.swing.JFrame {

    /**
     * Creates new form dataBarang
     */
    public dataPeminjamanInfo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataPeminjamanInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataPeminjamanInfo().setVisible(true);
            }
        });
    }
